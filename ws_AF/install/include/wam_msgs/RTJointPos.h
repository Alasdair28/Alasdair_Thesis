...
struct RTJointPos_
{
  ...
  _joints_type joints;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _rate_limits_type;
...
bool operator==(const ::wam_msgs::RTJointPos_<ContainerAllocator1> & lhs, const ::wam_msgs::RTJointPos_<ContainerAllocator2> & rhs)
{

...
(defsystem "wam_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "FtTorques" :depends-on ("_package_FtTorques"))
    (:file "_package_FtTorques" :depends-on ("_package"))
    ...
    (:file "tactilePressure" :depends-on ("_package_tactilePressure"))
    (:file "_package_tactilePressure" :depends-on ("_package"))
    (:file "tactilePressureArray" :depends-on ("_package_tactilePressureArray"))
    (:file "_package_tactilePressureArray" :depends-on ("_package"))
  ))
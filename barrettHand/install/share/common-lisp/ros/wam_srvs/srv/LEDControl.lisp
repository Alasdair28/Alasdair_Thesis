...
(cl:defmethod cl:initialize-instance :after ((m <LEDControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LEDControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_srvs-srv:<LEDControl-request> is deprecated: use wam_srvs-srv:LEDControl-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <LEDControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LEDControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_srvs-srv:<LEDControl-response> is deprecated: use wam_srvs-srv:LEDControl-response instead.")))

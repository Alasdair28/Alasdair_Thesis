...
(cl:defmethod cl:initialize-instance :after ((m <LASERControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LASERControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_srvs-srv:<LASERControl-request> is deprecated: use wam_srvs-srv:LASERControl-request instead.")))

(cl:ensure-generic-function 'turn_on-val :lambda-list '(m))
(cl:defmethod turn_on-val ((m <LASERControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_srvs-srv:turn_on-val is deprecated.  Use wam_srvs-srv:turn_on instead.")
  (turn_on m))
...
(cl:defmethod cl:initialize-instance :after ((m <LASERControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LASERControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_srvs-srv:<LASERControl-response> is deprecated: use wam_srvs-srv:LASERControl-response instead.")))

...
(defsystem "baxter_core_msgs-srv"
  ...
  :components ((:file "_package")
    (:file "BridgePublishersAuth" :depends-on ("_package_BridgePublishersAuth"))
    (:file "_package_BridgePublishersAuth" :depends-on ("_package"))
    (:file "BridgePublishersForce" :depends-on ("_package_BridgePublishersForce"))
    (:file "_package_BridgePublishersForce" :depends-on ("_package"))
